...
Additionally, you will need to make a copy of your personal references, using the second version with a key name adding \texttt{-hidden}. For example, if your reference key is \texttt{myotherpublication}, make a copy called \texttt{myotherpublication-hidden} that has text displayed how you would like it displayed in blind review mode. 
You will note that \anonybib{mypublication} and \anonybib{myotherpublication} were written by me, so in blind mode, the identifying pats will be suppressed.
